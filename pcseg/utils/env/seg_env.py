...
"""
This module is used to store environmental parameters in PCSeg.
...
DATA_HOME : The directory to store the automatically downloaded dataset, e.g S2DIS.
    ...
    if 'SEG_HOME' in os.environ:
        ...
        if os.path.exists(home_path):
            if os.path.isdir(home_path):
                ...
                logging.info('SEG_HOME {} is a file!'.format(home_path))
        else:
            return home_path
